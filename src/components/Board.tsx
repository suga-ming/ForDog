  ...
  return (
    <Post>
      ...
      <Solid className="flex justify-around">
        <Solid2 className="flex py-3 w-1/2 justify-center">
          <svg
            className="w-4 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          ...
          <div className="text-base ">공감해요</div>
        </Solid2>
        <div className="flex py-3 w-1/2 justify-center">
          <svg
            className="w-4 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          ...
          <div className="text-base text-gray">댓글달기</div>
        </div>
      </Solid>
    </Post>
  );
