  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        data?.items.map((item) => (
          <Solid className="flex pl-12 items-center py-4 relative">
            <svg
              className="w-4 rotate-90 mr-7"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
            >
              <path
            ...
            <div className="">
              <div className="flex items-center mb-2">
                <div className="flex items-center mr-2">
                  ...
                  <div className="text-gray-600 text-sm">{item?.writer}</div>
                </div>
