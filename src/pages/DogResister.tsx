...
const DogResister = () => {
  ...
  //   console.log("togetherYear", togetherYear);
  //   console.log("togetherMonth", togetherMonth);
  //   console.log("togetherDate", togetherDate);
  //   console.log("birthDates", birthDates);
  //   const togetherDates =
  //     togetherYear + "-" + togetherMonth + "-" + togetherDate;
  //   setTogetherDay(togetherDates);
  //   console.log("togetherDates", togetherDates);
  //   // api
  //   // const bodyData = {
  //   //   gender: gender,
